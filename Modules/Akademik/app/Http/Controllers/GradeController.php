...
class GradeController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('akademik::grades.index', compact('grades', 'classrooms', 'subjects', 'gradeTypes'));
    }
    ...
    public function create(Request $request): View
    {
        ...
        return view('akademik::grades.create', compact(
            'classrooms',
            'selectedClassroom',
            'subjects',
            'selectedSubject',
    ...
    public function show(Grade $grade): View
    {
        ...
        return view('akademik::grades.show', compact('grade'));
    }
    ...
    public function rapor(Request $request)
    {
        ...
        if (!$student) {
            return view('akademik::grades.rapor', compact('students', 'student'))
        ...
        if ($request->input('export') === 'pdf') {
            $pdf = Pdf::loadView('akademik::grades.rapor-pdf', compact('student', 'raporData', 'attendanceSummary'));
            $pdf->setPaper('a4', 'portrait');
            return $pdf->stream("rapor-{$student->nis}-" . now()->format('Y-m-d') . '.pdf');
        }

        return view('akademik::grades.rapor', compact('students', 'student', 'raporData', 'attendanceSummary'));
    }
